...
PROJECT_NAME ?= provider-googleworkspace
PROJECT_REPO ?= github.com/alanraison/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.3.3

export TERRAFORM_PROVIDER_SOURCE ?= hashicorp/googleworkspace
export TERRAFORM_PROVIDER_REPO ?= https://github.com/hashicorp/terraform-provider-googleworkspace
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-googleworkspace_v0.7.0
...
xpkg.build.provider-googleworkspace: do.build.images
