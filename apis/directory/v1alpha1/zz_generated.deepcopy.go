...
func (in *AssignmentParameters) DeepCopyInto(out *AssignmentParameters) {
	*out = *in
	...
	if in.AssignedToRef != nil {
		in, out := &in.AssignedToRef, &out.AssignedToRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.AssignedToSelector != nil {
		in, out := &in.AssignedToSelector, &out.AssignedToSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.OrgUnitID != nil {
	...
	if in.OrgUnitIDRef != nil {
		in, out := &in.OrgUnitIDRef, &out.OrgUnitIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.OrgUnitIDSelector != nil {
		in, out := &in.OrgUnitIDSelector, &out.OrgUnitIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.RoleID != nil {
